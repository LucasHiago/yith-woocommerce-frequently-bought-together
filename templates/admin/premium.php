...
.section.two{
    background: url(<?php echo YITH_WFBT_ASSETS_URL?>/images/02-bg.png) no-repeat #fff; background-position: 85% 75%
}
.section.three{
    background: url(<?php echo YITH_WFBT_ASSETS_URL?>/images/03-bg.png) no-repeat #fff; background-position: 85% 75%
}
.section.four{
    background: url(<?php echo YITH_WFBT_ASSETS_URL?>/images/04-bg.png) no-repeat #fff; background-position: 85% 75%
}
.section.five{
    background: url(<?php echo YITH_WFBT_ASSETS_URL?>/images/05-bg.png) no-repeat #fff; background-position: 85% 75%
}
.section.six{
    background: url(<?php echo YITH_WFBT_ASSETS_URL?>/images/06-bg.png) no-repeat #fff; background-position: 85% 75%
}
    ...
    <div class="section section-cta section-odd">
        <div class="landing-container">
            <div class="premium-cta">
                <p>
                    <?php echo sprintf( __('Upgrade to %1$spremium version%2$s of %1$sYITH WooCommerce Frequently Bought Together%2$s to benefit from all features!','ywbt'),'<span class="highlight">','</span>' );?>
                </p>
                <a href="<?php echo $this->get_premium_landing_uri() ?>" target="_blank" class="premium-cta-button button btn">
                    <span class="highlight"><?php _e('UPGRADE','ywbt');?></span>
                    <span><?php _e('to the premium version','ywbt');?></span>
                </a>
            </div>
        </div>
    </div>
    <div class="one section section-even clear">
        <h1><?php _e('Premium Features','ywbt');?></h1>
        <div class="landing-container">
            <div class="col-1">
            ...
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Number of products associated','ywbt');?></h2>
                </div>
                <p>
                    <?php echo sprintf(__('You might decide to suggest your customers to buy products in combination, but you do not want to weigh your shop page down. Do not be afraid, you can do that with %1$sYITH WooCommerce Frequently Bought Together%2$s.%3$sAssociate as many products as you want to a product of your shop, but then decide how many of them showing. They will be selected randomly and suggested to your customers.', 'ywbt'), '<b>', '</b>','<br>');?>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Image size','ywbt');?></h2>
                </div>
                <p>
                    <?php echo sprintf(__('All items added by the plugin into product detail page will be shown with their image too.%3$sDo not be afraid of the quality, just care about choosing its final %1$ssize%2$s and crop it if you think it\'s better to do so.', 'ywbt'), '<b>', '</b>','<br>');?>
                </p>
            </div>
            <div class="col-1">
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Integration with Wishlist','ywbt');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __( 'To make you fully enjoy all plugin functionalities we have also integrated it with %1$sYITH WooCommerce Wishlist%2$s.%3$sEnable both plugins, set their options appropriately and in each user will be able to see in his/her own Wishlist page a %1$sslider%2$s with all products associated at least at one of the items in wishlist.','ywbt' ),'<b>','</b>','<br>' ) ?>
                </p>
            </div>
            <div class="col-1">
